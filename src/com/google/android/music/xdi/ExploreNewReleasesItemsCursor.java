...
class ExploreNewReleasesItemsCursor extends XdiCursor
{
  ...
  ExploreNewReleasesItemsCursor(Context paramContext, String[] paramArrayOfString, long paramLong, int paramInt, String paramString)
  {
  ...
  private static Cursor getCursorForHeader(Context paramContext, long paramLong, int paramInt, String paramString)
  {
    ...
    {
      return localObject;
      localUri = MusicContent.Explore.getNewReleasesUri(paramLong, paramString);
 ...
 * Qualified Name:     com.google.android.music.xdi.ExploreNewReleasesItemsCursor
