  ...
  implements ActionBarDrawerToggle.DelegateProvider, TaskStackBuilder.SupportParentable, ActionBar.Callback
{
  ...
  {
    ActionBarActivityDelegate localActionBarActivityDelegate = ActionBarActivityDelegate.createDelegate(this);
    this.mImpl = localActionBarActivityDelegate;
  ...
  {
    TaskStackBuilder localTaskStackBuilder = paramTaskStackBuilder.addParentStack(this);
  }
